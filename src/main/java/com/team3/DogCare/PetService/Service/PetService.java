...
public class PetService {
    ...
    public checkResponse checkSkin(MultipartFile image, Long petId) throws IOException, URISyntaxException {
        ...
        if (confidence <= 70) {
            ...
            if (code == 1 ){
                Disease = String.format("구진, 플라크 (AI진단 신뢰도: %.2f%%)", confidence);
                ...
                Disease = String.format("비듬,각질,상피성잔고리 (AI진단 신뢰도: %.2f%%)", confidence);
                ...
                Disease = String.format("과다색소침착, 태선화 (AI진단 신뢰도: %.2f%%)", confidence);
                ...
                Disease = String.format("농포,여드름 (AI진단 신뢰도: %.2f%%)", confidence);
    ...
    public checkResponse checkEyes(MultipartFile image,Long petId) throws IOException, URISyntaxException {
        ...
        if (confidence <= 70) {
            ...
            if (code == 1 ){
                ...
                Disease = String.format("안검내반증 (AI진단 신뢰도: %.2f%%)", confidence);
                info = "개의 눈꺼풀 가장자리가 눈으로 말려 들어가 피모가 항상 닿아 있어 이로 인해 눈물 흘림과 눈 비빔, " +
                        "깜박임 등 다양한 형태의 증상이 나타나는 것을 말합니다.";
            }else if(code == 4){
                Disease = String.format("유루증 (AI진단 신뢰도: %.2f%%)", confidence);
                ...
                Disease = String.format("핵경화 (AI진단 신뢰도: %.2f%%)", confidence);
                ...
                Disease = String.format("비궤양성 각막염 (AI진단 신뢰도: %.2f%%)", confidence);
                ...
                Disease = String.format("유리체 변성 (AI진단 신뢰도: %.2f%%)", confidence);
